...
Description
===========
This file contains the functions required to display an interactive user interface :)
...
def submit_name(event):
    """Return the analysis of the text inputted by the user"""
    # save the text provided by the users
    text = name_entry.get("1.0", "end-1c")

    # analyse the text
    results = analysis.compellingness_with_description(text)
    score = results[0]
